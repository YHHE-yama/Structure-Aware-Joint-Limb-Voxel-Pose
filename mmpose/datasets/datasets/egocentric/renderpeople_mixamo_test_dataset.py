...
class RenderpeopleMixamoTestDataset(Dataset):    #用于 评估测试阶段（Test phase） 的 3D 全身+手部数据集类，主要基于 Renderpeople + Mixamo 合成数据构建，并集成了对 renderpeople_old 和 renderpeople 两种数据格式的支持。
