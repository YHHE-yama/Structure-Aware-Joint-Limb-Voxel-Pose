...
class MocapStudioDataset(Dataset):   #从多个 egocentric mocap 测试序列中读取图像与对应的标注关键点 3D 姿态，支持灵活的坐标转换（Mo2Cap2 → SMPLX），并实现了全套精度评估流程
    ...
    def load_annotations(self):
        ...
        for seq_name in self.path_dict:
            ...
            for pose_gt_item in pose_gt_data:                               #[:20]只有前二十个
