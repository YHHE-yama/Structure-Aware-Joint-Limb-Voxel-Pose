...
#from mmpose.datasets.datasets.egocentric.mocap_studio_dataset_limb import fisheye2voxel, generate_limb_heatmap_3d
...
class LimbMocapStudioFinetuneDataset(Dataset):
    ...
    path_dict = {
        'jian1': {
            'path': r'path to /SceneEgo/train/jian1',
        },
        'jian2': {
            'path': r'path to /SceneEgo/train/jian2',
        },
        'diogo1': {
            'path': r'path to/SceneEgo/train/diogo1',
        },
        'diogo2': {
            'path': r'path to/SceneEgo/train/diogo2',
        },
        'pranay2': {
            'path': r'path to/SceneEgo/train/pranay2',
        },
    }
