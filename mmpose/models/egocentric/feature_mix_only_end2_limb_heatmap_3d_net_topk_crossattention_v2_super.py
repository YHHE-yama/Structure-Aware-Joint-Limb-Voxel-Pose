...
class TopKCrossattenyionHeatmap3DNet_v2_super(nn.Module):
    def __init__(self,
                 in_channels=768,
                 num_deconv_layers=2,
        ...
        super(TopKCrossattenyionHeatmap3DNet_v2_super, self).__init__()
        ...
        self.limb_loss_weight = 0.001  # 🔧 可以调节，例如 0.1 ~ 1.0 之间  0.5
        self.lambda_dir = 0.001   # 原来写死在 get_loss 里的 1e-3
        self.lambda_len = 0.001
    ...
    def get_loss(self, output, keypoints_3d, keypoint_3d_visible=None, **kwargs):
        ...
        losses['bone_dir'] = self.lambda_dir * angle_loss
        losses['bone_len'] = self.lambda_len * len_loss
