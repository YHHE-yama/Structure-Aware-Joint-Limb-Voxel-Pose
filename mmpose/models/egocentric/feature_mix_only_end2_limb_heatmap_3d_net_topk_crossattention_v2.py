...
class TopKCrossattenyionHeatmap3DNet_v2(nn.Module):
    def __init__(self,
                 in_channels=768,
                 num_deconv_layers=2,
        ...
        super(TopKCrossattenyionHeatmap3DNet_v2, self).__init__()
    ...
    def get_accuracy(self, output, keypoints_3d, keypoint_3d_visible=None):
        ...
        mpjpe = keypoint_mpjpe(
            ...
            mask=keypoint_3d_visible.detach().cpu().numpy().astype(np.bool), alignment='root')
